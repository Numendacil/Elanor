...
void AddClientHashHeader(httplib::Headers& headers)
{
	// NOLINTBEGIN
...
{
	AddClientHashHeader(headers);
	headers.emplace("user-agent", "PixivAndroidApp/5.0.234 (Android 11; Pixel 5)");
	headers.emplace("app-version", "5.0.234");
	headers.emplace("app-os-version", "Android 11.0");
	headers.emplace("app-os", "Android");
	headers.emplace("accept-language", "zh-cn");
}
...
void PixivClient::_login()
{
	...
	auto result = this->_OauthCli.Post("/auth/token", headers, params);
...
string PixivClient::DownloadIllust(const string& url)
{
	...
	auto result = this->_DownloadCli.Get(
		component.path, 
		httplib::Headers{
...
void PixivClient::DownloadIllust(const string& url, httplib::ContentReceiver receiver)
{
	Utils::UrlComponent component = Utils::UrlComponent::ParseUrl(url);
...
json PixivClient::GetUserDetails(PUID_t UserId)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/user/detail", params, headers));
}
...
json PixivClient::SearchUser(string name, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/search/user", params, headers));
}
...
json PixivClient::FollowUser(PUID_t UserId, RESTRICT restrict)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Post("/v1/user/follow/add", headers, params));
}
...
json PixivClient::UnfollowUser(PUID_t UserId)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Post("/v1/user/follow/delete", headers, params));
}
...
json PixivClient::GetUserBookmarkTags(PUID_t UserId, RESTRICT restrict, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/user/bookmark-tags/illust", params, headers));
}
...
json PixivClient::GetUserIllusts(PUID_t UserId, ContentType type, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/user/illusts", params, headers));
}
...
json PixivClient::GetUserNovels(PUID_t UserId, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/user/novels", params, headers));
}
...
json PixivClient::GetUserFollowing(PUID_t UserId, RESTRICT restrict, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/user/following", params, headers));
}
...
json PixivClient::GetUserFollower(PUID_t UserId, RESTRICT restrict, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/user/follower", params, headers));
}
...
json PixivClient::GetUserMyPixiv(PUID_t UserId, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/user/mypixiv", params, headers));
}
...
json PixivClient::GetUserBlacklist(PUID_t UserId, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v2/user/list", params, headers));
}
				...
				PID_t MaxBookmarkId, string tag)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/user/bookmarks/illust", params, headers));
}
...
json PixivClient::GetRelatedUsers(PUID_t UserId, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/user/related", params, headers));
}
...
json PixivClient::GetRecommendedUser(uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/user/recommended", params, headers));
}
...
json PixivClient::GetFollowedIllust(RESTRICT restrict, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v2/illust/follow", params, headers));
}
...
json PixivClient::GetIllustDetails(PID_t pid)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/illust/detail", params, headers));
}
...
json PixivClient::GetIllustComments(PID_t pid, uint64_t offset, bool IncludeTotalComments)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/illust/comments", params, headers));
}
...
json PixivClient::GetRelatedIllusts(PID_t pid, uint64_t offset, const std::vector<PID_t>& seeds)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v2/illust/related", params, headers));
}
	...
	bool include_privacy_policy)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/illust/recommended", params, headers));
}
...
json PixivClient::GetIllustRanking(RankingMode option, std::string date, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/illust/ranking", params, headers));
}
...
json PixivClient::GetTrendingTagsIllust()
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/trending-tags/illust", params, headers));
}
...
json PixivClient::GetTrendingTagsNovel()
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/trending-tags/novel", params, headers));
}
			...
			bool MergePlainKeywordResult, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/search/illust", params, headers));
}
...
json PixivClient::GetIllustBookmarkDetails(PID_t pid)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v2/illust/bookmark/detail", params, headers));
}
...
json PixivClient::AddBookmark(PID_t pid, RESTRICT restrict, const std::vector<std::string>& tags)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Post("/v2/illust/bookmark/add", headers, params));
}
...
json PixivClient::DeleteBookmark(PID_t pid)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Post("/v2/illust/bookmark/delete", headers, params));
}
...
json PixivClient::GetUgoiraMetadata(PID_t pid)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/ugoira/metadata", params, headers));
}
...
json PixivClient::GetNovelSeries(uint64_t SeriesId, std::string LastOrder)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v2/novel/series", params, headers));
}
...
json PixivClient::GetNovelDetails(PNID_t pnid)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v2/novel/detail", params, headers));
}
...
json PixivClient::GetNovelComments(PNID_t pnid, uint64_t offset, bool IncludeTotalComments)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/novel/comments", params, headers));
}
...
json PixivClient::GetNovelText(PNID_t pnid)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/novel/text", params, headers));
}
			...
			bool MergePlainKeywordResult, uint64_t offset)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/search/novel", params, headers));
}
		...
		bool include_privacy_policy)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v1/novel/recommended", params, headers));
}
...
json PixivClient::AutoComplete(string keyword, bool MergePlainKeywordResult)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get("/v2/search/autocomplete", params, headers));
}
...
json PixivClient::NextPage(const std::string& NextUrl)
{
	...
	return Utils::GetJsonResponse(this->_ApiCli.Get(component.GetRelativeRef(), {}, headers));
}
